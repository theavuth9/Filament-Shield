...
namespace Theavuth9\FilamentShield\Commands;
        ...
        if (! $this->option('minimal')) {
            if ($this->confirm('Would you like to show some love by starring the repo?', true)) {
                if (PHP_OS_FAMILY === 'Darwin') {
                    exec('open https://github.com/Theavuth9/filament-shield');
                }
                if (PHP_OS_FAMILY === 'Linux') {
                    exec('xdg-open https://github.com/Theavuth9/filament-shield');
                }
                if (PHP_OS_FAMILY === 'Windows') {
                    exec('start https://github.com/Theavuth9/filament-shield');
                }
